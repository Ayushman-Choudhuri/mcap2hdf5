...
class KittiHDF5Dataset(Dataset):
    def __init__(self, h5FilePath: str, transform: Any | None = None):
...
def kitti_collate_fn(batch: list[dict]) -> dict[str, Any]:
    ...
    return {"images": images, "lidars": lidars, "timestamps": timestamps, "indices": indices}
...
if __name__ == "__main__":
    ...
    for batch in loader:
        print(
            f"Batch loaded: Image shape {batch['images'].shape}, "
